                    ...
                    <div class="card border-0 mb-4">
                        ...
                        <div class="card-body">
                            {{-- <form id="filterForm" method="GET" action="{{ route('enquiry') }}" class="mb-4">
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" id="title" name="title" class="form-control" placeholder="" value="{{ (isset($_GET['title']) && $_GET['title']) ? $_GET['title'] : '' ; }}">
                                    </div>
                            ...
                            <table id="" class="table table-striped table-bordered align-middle">
                                ...
                                <tbody>
                                    <form action="{{ route('enquiry.destroy') }}" method="POST" style="display: inline;">
                           ...
                           @switch(@$lead->loan_status)
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        {{-- <td>
                                            ...
                                            <a href="#" class="text-secondary me-2" data-bs-toggle="modal"
                                                ...
                                                <a  class="btn btn-link text-danger p-0" onclick="rejectLead({{ $lead->id }})" >
                                                    <i class="fa fa-ban"></i>
                                                </button>
                            ...
                            <div class="d-flex justify-content-center">
                                <p class="m-0">Showing {{ $alllead->firstItem() }} to {{ $alllead->lastItem() }} of {{ $alllead->total() }} records</p>
                                {{-- {{ $alllead->links() }} --}}
                                {{ $alllead->appends(request()->query())->links() }}
                            </div>
                        </div>
                    </div>
                </div>
